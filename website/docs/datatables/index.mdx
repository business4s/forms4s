...
```scala file=./main/scala/forms4s/example/docs/DatatableExample.scala start=start_server_mode end=end_server_mode
```

### Tyrian Integration with Server Mode

```scala file=./main/scala/forms4s/example/docs/DatatableTyrianExample.scala start=start_server_tyrian end=end_server_tyrian
```